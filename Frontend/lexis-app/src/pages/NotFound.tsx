...
const NotFound = () => {
  return (
    <main className="grid min-h-screen place-items-center bg-light px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <p className="mt-6 text-pretty text-lg font-medium text-gray-700 sm:text-xl/8">Sorry, we couldn't find the page you're looking for.</p>
